...
CSOURCES = bank0.c gen.c main.c sound.c title.c rand.c mob.c pickup.c ai.c gameplay.c inventory.c palette.c spr.c float.c msg.c sprite.c targeting.c gameover.c animate.c
